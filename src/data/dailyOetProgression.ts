...
export const dailyOetProgression: readonly DailyOetProgressionEntry[] = [
  ...
  },
  {
    ...
    reasoningLayers: [
      ...
      'analysis of informative missingness with interpreter-mediated autonomous consent',
      'estimand alignment after treatment switching with supported decision-making under fluctuating capacity',
      'diagnosis of practical positivity failure with value-concordant time-limited treatment under surrogate conflict',
    ],
    level: 'advanced',
    focus:
      'Unsupported counterfactuals and bounded treatment trials: recognise when excellent covariate balance masks absent treatment overlap, distinguish an overlap-population estimate from network-wide transportability, compress obstructive shock after intracranial surgery into an intervention-focused transfer, and negotiate a goal-defined ventilation trial that centres prior patient values during surrogate conflict.',
    taskIds: {
      listening: 'lis-120',
      reading: 'read-92',
      writing: 'write-46',
  ...
  },
  {
    ...
    reasoningLayers: [
      ...
      'estimand alignment after treatment switching with supported decision-making under fluctuating capacity',
      'diagnosis of practical positivity failure with value-concordant time-limited treatment under surrogate conflict',
      'recognition of selection induced by care pathways with transparent disclosure after diagnostic discordance',
    ],
    level: 'advanced',
    focus:
      'Care-pathway selection and accountable uncertainty: recognise how admission or reference-standard decisions can manufacture reassuring associations, distinguish verified-subgroup accuracy from performance in the target clinic, compress probable anti-NMDA receptor encephalitis despite discordant early tests into an urgent neurocritical transfer, and disclose a missed pulmonary embolism while rebuilding trust without speculation or false guarantees.',
    taskIds: {
      listening: 'lis-121',
      reading: 'read-93',
      writing: 'write-47',
  ...
  },
  {
    ...
    reasoningLayers: [
      ...
      'diagnosis of practical positivity failure with value-concordant time-limited treatment under surrogate conflict',
      'recognition of selection induced by care pathways with transparent disclosure after diagnostic discordance',
      'separation of observation-process effects from biological change with phenotype-led action after an uncertain genomic result',
    ],
    level: 'advanced',
    focus:
      'Observation-process bias and phenotype-led action: recognise when unequal, prognosis-related testing moves a recorded recovery date without proving faster biology, separate surveillance from the care it triggers, compress unstable type A aortic dissection after initial acute-coronary treatment into an immediate surgical transfer, and explain an uncertain genetic variant without converting it into a diagnosis, invasive treatment or predictive testing.',
    taskIds: {
      listening: 'lis-122',
      reading: 'read-94',
      writing: 'write-48',
  ...
  },
  {
    ...
    reasoningLayers: [
      ...
      'recognition of selection induced by care pathways with transparent disclosure after diagnostic discordance',
      'separation of observation-process effects from biological change with phenotype-led action after an uncertain genomic result',
      'tracking of self-correction and controlling exceptions while maintaining a proportionate therapeutic boundary',
    ],
    level: 'advanced',
    focus:
      'Response-mode switching and proportionate boundaries: produce exact Listening Part A wording after a speaker self-corrects, extract the controlling exception from a terse Reading Part B safety policy, write a selective discharge letter after euglycaemic ketoacidosis with a misleading near-normal glucose, and refuse unsafe early opioid replacement while assessing withdrawal and overdose risk without rupturing trust.',
    taskIds: {
      listening: 'lis-123',
      reading: 'read-95',
      writing: 'write-49',
