...
Pain should be assessed using validated tools such as the Numeric Rating Scale (0–10) or the Visual Analogue Scale. Re-assessment after intervention is essential. In patients with cognitive impairment, behavioural pain assessment tools such as the PAINAD scale should be used.`,
  ...
  'passage-aki-contrast-policy': {
    id: 'passage-aki-contrast-policy',
    title: 'Policy — Iodinated contrast in acute kidney injury risk',
    text: `Radiology Contrast Safety Update\n\nIodinated contrast should not be delayed when imaging is clinically urgent, but the request must document the renal-risk discussion for patients with acute kidney injury or an eGFR below 30 ml/min/1.73m2. The duty radiologist, referrer, and patient should agree whether diagnostic benefit outweighs renal risk.\n\nHydration: For inpatients at high risk, prescribe isotonic intravenous fluid unless contraindicated by heart failure or pulmonary oedema. Oral hydration alone is insufficient for unstable patients. Creatinine must be rechecked 48-72 hours after contrast in high-risk cases.\n\nMedication: Metformin is not routinely stopped for normal renal function. It should be withheld on the day of contrast and for 48 hours afterwards only when eGFR is below 30, there is acute kidney injury, or intra-arterial contrast is used. Non-steroidal anti-inflammatory drugs should be reviewed and avoided where possible.\n\nDo not use this policy to refuse urgent CT pulmonary angiography in suspected massive pulmonary embolism. In such cases, senior documentation of the risk-benefit decision is enough; renal-protective steps follow once the patient is stabilised.\n\nThis update replaces the older blanket rule that cancelled all contrast scans when creatinine was above the laboratory reference range.`,
  },
  'passage-capacity-fluctuation': {
    id: 'passage-capacity-fluctuation',
    title: 'Guidance — Fluctuating mental capacity and consent',
    text: `Consent guidance for patients with fluctuating capacity\n\nCapacity is decision-specific and time-specific. A patient with delirium, hypoglycaemia, severe pain, or intoxication may lack capacity for a complex operation at 02:00 but regain capacity after treatment or rest. Clinicians must not label a patient globally incapable because one decision was deferred.\n\nThe assessor must test four abilities: understand relevant information, retain it long enough, use or weigh it, and communicate a choice. If the patient fails one element, practical support should be attempted before concluding incapacity. Examples include using an interpreter, written prompts, hearing aids, pain relief, or delaying a non-urgent decision until the patient is more alert.\n\nBest interests decisions apply only when the patient lacks capacity and delay would cause harm or the decision cannot reasonably wait. Past wishes, beliefs, values, and views of those close to the patient must be considered, but family members do not automatically become decision-makers unless they hold a valid legal authority.\n\nFor refusal of life-sustaining treatment, extra care is needed: apparent refusal during transient confusion should prompt reassessment, whereas a capacitous refusal must be respected even if clinicians disagree.`,
  },
  'passage-nec-fasc-triage': {
    id: 'passage-nec-fasc-triage',
    title: 'Emergency protocol — Necrotising soft tissue infection',
    text: `Necrotising soft tissue infection: escalation protocol\n\nNecrotising fasciitis may initially resemble cellulitis. Red flags include pain out of proportion to skin findings, rapidly spreading erythema, dusky discolouration, skin anaesthesia, crepitus, shock, or systemic toxicity. A normal early X-ray does not exclude the diagnosis.\n\nEscalation: If necrotising infection is suspected, call the on-call surgical consultant immediately and give broad-spectrum intravenous antibiotics after blood cultures. Do not wait for MRI if it would delay theatre. CT may help define gas or fascial involvement but is an adjunct, not a gatekeeper to surgery.\n\nLaboratory scores such as LRINEC can support decision-making but have insufficient sensitivity to rule out disease. A low score must not reassure clinicians when clinical features are concerning.\n\nSource control is definitive: urgent debridement, repeated inspection, and critical care support as needed. Mark the skin edge, photograph where local policy permits, and document neurovascular findings before transfer.\n\nCommon diagnostic traps include mislabelling severe pain as drug-seeking behaviour, treating bilateral leg erythema as cellulitis without considering oedema, and delaying referral until blistering develops.`,
  },
  'passage-noninferiority-statins': {
    id: 'passage-noninferiority-statins',
    title: 'Abstract — Non-inferiority trial of statin de-escalation',
    text: `Background: Some older adults report muscle symptoms on high-intensity statins after myocardial infarction. We tested whether moderate-intensity statin plus ezetimibe was non-inferior to high-intensity statin alone for LDL reduction at 12 months.\n\nMethods: In this open-label, multicentre non-inferiority trial, 1,120 participants aged over 70 were randomised 1:1. The non-inferiority margin was 0.25 mmol/L for mean LDL difference. Allocation was concealed centrally; outcome laboratory staff were blinded.\n\nResults: Mean LDL at 12 months was 1.82 mmol/L in the combination group and 1.76 mmol/L in the high-intensity group, difference 0.06 mmol/L (95% CI -0.02 to 0.14). Because the upper confidence limit was below the prespecified 0.25 mmol/L margin, non-inferiority was met. Myalgia-related discontinuation was lower in the combination group.\n\nInterpretation: The trial supports an alternative lipid-lowering strategy for selected older patients intolerant of high-intensity statins. It does not prove superiority for cardiovascular events, as the study was powered for LDL change, not infarction or mortality.\n\nLimitation: Open-label treatment may have influenced reporting of muscle symptoms despite blinded laboratory assessment.`,
  },
  'passage-pharmacovigilance-signal': {
    id: 'passage-pharmacovigilance-signal',
    title: 'Bulletin — Pharmacovigilance signal for GLP-1 medicines',
    text: `Medicines Safety Bulletin: GLP-1 receptor agonists and severe gastrointestinal symptoms\n\nSpontaneous adverse event reports have increased for severe nausea, persistent vomiting, dehydration, and suspected gastroparesis in patients using GLP-1 receptor agonists. A signal does not prove causation; it indicates that further assessment is warranted.\n\nClinicians should advise patients to seek review if vomiting persists beyond 24 hours, if they cannot maintain oral fluids, or if they develop severe abdominal pain. Consider pancreatitis, bowel obstruction, gallbladder disease, and diabetic ketoacidosis in the differential diagnosis. Temporarily withhold the medicine during significant dehydration or acute illness.\n\nDose escalation should be gradual and paused when symptoms are more than mild. Restarting after severe symptoms requires individual risk-benefit assessment rather than automatic continuation at the previous dose.\n\nReport serious or unexpected events through the national pharmacovigilance portal, including dose, duration, renal function, concurrent medicines, and outcome. The bulletin does not instruct clinicians to stop GLP-1 therapy in all patients; many tolerate treatment well and gain metabolic benefit.`,
  },
  'passage-model-drift-study': {
    id: 'passage-model-drift-study',
    title: 'Commentary — When stable accuracy conceals model drift',
    text: `A deterioration-alert model was introduced across three hospitals after reporting an area under the receiver-operating curve of 0.86 during local development. Twelve months later, aggregate discrimination remained 0.85, a result that initially reassured the implementation group. Closer analysis told a less comfortable story. Sensitivity had fallen substantially for patients arriving through the new same-day emergency pathway and for people whose first language was not English, while improving slightly in elective admissions.

The change coincided with two shifts: community observations began entering the record through a different interface, and the emergency pathway admitted a less acutely unwell case mix. Neither change constituted a conventional software fault. Instead, the relationship between available predictors, workflow and outcome had altered. Alert acknowledgement also declined, although interviews suggested that clinicians were responding selectively rather than simply ignoring the system.

Recalibration corrected the model's tendency to overestimate absolute risk but did not fully restore subgroup sensitivity. The authors therefore resist describing recalibration as validation. They argue that a model may remain well calibrated on average while failing the patients for whom missed deterioration is most consequential. Likewise, a stable headline discrimination statistic does not establish transportability.
